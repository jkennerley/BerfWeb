...
///                        (tableMeta.Table.TableName)  
///          
///    { Lang = FSHARP ; Type = LANG_ELEMENT_INSERT ; Code = code }
///
//////
///let getInsertCrudFSharp tableMeta  = 
///    // let fieldsList = getFieldsListStringWithAt tableMeta
///    let fieldsList = getFieldsListStringWithPrePost tableMeta
///
///    let code = sprintf 
///                        """
//////
///let AAA_insert%s (be : %s) =
///    let cmd = new DataAccess.Insert%s()
///    cmd.Execute
///        (%s)
///
...
///                        procName
///          
///    { Lang = FSHARP ; Type = LANG_ELEMENT_READ ; Code = code }
///
//////
///let getReadFSharp tableMeta  = 
///    getReadFSharpByLockStyle false tableMeta  
...
///                        (tableMeta.Table.TableName)  
///          
///    { Lang = FSHARP ; Type = LANG_ELEMENT_DELETE ; Code = code }
///
//////    
///let getInsertSql tableMeta = 
///    let procNamePrefix  = getProcNamePrefix
...
///    let tables = 
///        getTables 
///        |> Seq.where (fun x -> (whiteList |>  Seq.exists (fun y -> y = x.TableName) ))
///        |> Seq.sortBy (fun x -> x.TableName  ) 
///        |> Seq.toList
///
///    let pkeys = 
...
///    {TableMeta.Table = table ; Pkeys = pkeys ; Cols = cols }
///
///let getTableMetaCodeElements =
///    let dbMeta  = getDbMeta 
///
///    let langElementsGrouped = 
///        dbMeta.Tables
///        |> Seq.map (fun table -> 
